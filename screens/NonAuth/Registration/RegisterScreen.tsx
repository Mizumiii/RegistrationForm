...
export default function RegisterScreen() {
    ...
    const registerSchema = yup.object({
        firstName: yup.string().required('Firstname address is a must'),
        lastName: yup.string().required('Lastname address is a must'),
        birthday: yup.mixed()
    ...
    return (
        <ViewWithLoading loading={loading}>
            <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 20,  }}>
                ...
                >Fill out Required Fields</CustomText>
                <Formik
                    initialValues={{
                        firstName: '',
                        lastName: '',
